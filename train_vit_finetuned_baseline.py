...
from models.vit_finetuned_baseline import ViTFinetunedBaseline
...
def main():
    ...
    model = ViTFinetunedBaseline().to(device)  # 从64增至128
    ...
    for epoch in range(150):  # 训练轮次减至50（收敛更快）
        ...
        if metrics['rmse'] < best_rmse:
            ...
            torch.save(checkpoint, 'best_vitfinetuned_baseline_model.pth')
    ...
    print("\n" + "="*60)
    print("训练完成！最佳性能:")
    checkpoint = torch.load('best_vitfinetuned_baseline_model.pth', weights_only=False)
